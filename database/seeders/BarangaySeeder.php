...
class BarangaySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $barangays = [
            ...
            ['name' => 'A. BONIFACIO-CAGUIOA-RIMANDO (ABCR)', 'latitude' => 16.4188, 'longitude' => 120.5976],
            ['name' => 'ABANAO-ZANDUETA-KAYONG-CHUGUM-OTEK (AZKCO)', 'latitude' => 16.4136, 'longitude' => 120.5934],
            ['name' => 'ALFONSO TABORA', 'latitude' => 16.4234, 'longitude' => 120.5969],
            ['name' => 'AMBIONG', 'latitude' => 16.4288, 'longitude' => 120.6081],
            ['name' => 'ANDRES BONIFACIO (LOWER BOKAWKAN)', 'latitude' => 16.4174, 'longitude' => 120.5856],
            ['name' => 'LOAKAN APUGAN', 'latitude' => 16.3828, 'longitude' => 120.6246],
            ...
            ['name' => 'NORTH CENTRAL AURORA HILL', 'latitude' => 16.4250, 'longitude' => 120.6048],
            ['name' => 'SOUTH CENTRAL AURORA HILL', 'latitude' => 16.4254, 'longitude' => 120.6069],
            ...
            ['name' => 'BAKAKENG NORTE/SUR', 'latitude' => 16.3861, 'longitude' => 120.5909],
            ['name' => 'BAL-MARCOVILLE (MARCOVILLE)', 'latitude' => 16.4063, 'longitude' => 120.6035],
            ...
            ['name' => 'LOWER DAGSIAN', 'latitude' => 16.3919, 'longitude' => 120.6081],
            ['name' => 'UPPER DAGSIAN', 'latitude' => 16.3946, 'longitude' => 120.6075],
            ['name' => 'DIZON SUBDIVISION', 'latitude' => 16.4248, 'longitude' => 120.5899],
            ['name' => 'DOMINICAN-MIRADOR', 'latitude' => 16.4067, 'longitude' => 120.5817],
            ['name' => 'DONTOGAN', 'latitude' => 16.3818, 'longitude' => 120.5722],
            ['name' => 'DPS COMPOUND', 'latitude' => 16.4049, 'longitude' => 120.6049],
            ...
            ['name' => 'GEFA (LOWER Q.M)', 'latitude' => 16.4080, 'longitude' => 120.5899],
            ['name' => 'LOWER GENERAL LUNA', 'latitude' => 16.4150, 'longitude' => 120.5982],
            ['name' => 'UPPER GENERAL LUNA', 'latitude' => 16.4132, 'longitude' => 120.6016],
            ['name' => 'GIBRALTAR', 'latitude' => 16.4182, 'longitude' => 120.6230],
            ['name' => 'GREEN WATER', 'latitude' => 16.4014, 'longitude' => 120.6073],
            ['name' => 'GUISAD CENTRAL', 'latitude' => 16.4230, 'longitude' => 120.5855],
            ['name' => 'GUISAD SURONG', 'latitude' => 16.4203, 'longitude' => 120.5838],

            // // H Barangays === 7 Barangays
            ['name' => 'HAPPY HOLLOW', 'latitude' => 16.3950, 'longitude' => 120.6238],
            ['name' => 'HAPPY HOMES-LUCBAN', 'latitude' => 16.4280, 'longitude' => 120.5956],
            ['name' => 'HARRISON-CARRANTES', 'latitude' => 16.4117, 'longitude' => 120.5971],
            ['name' => 'HILLSIDE', 'latitude' => 16.3966, 'longitude' => 120.6047],
            ['name' => 'HOLYGHOST EXTENSION', 'latitude' => 16.4166, 'longitude' => 120.6040],
            ['name' => 'HOLYGHOST PROPER', 'latitude' => 16.4168, 'longitude' => 120.6008],
            ['name' => 'HONEYMOON-HOLYGHOST', 'latitude' => 16.4193, 'longitude' => 120.6008],

            // // I Barangays === 3 Barangays
            ['name' => 'IMELDA MARCOS', 'latitude' => 16.4002, 'longitude' => 120.5894],
            ...
            ['name' => 'LOAKAN LIWANAG', 'latitude' => 16.3861, 'longitude' => 120.6099],
            ...
            ['name' => 'LOWER LOURDES SUBDIVISION', 'latitude' => 16.4102, 'longitude' => 120.5851],
            ...
            ['name' => 'MAGSAYSAY PRIVATE RD.', 'latitude' => 16.4241, 'longitude' => 120.5934],
            ['name' => 'LOWER MAGSAYSAY', 'latitude' => 16.4208, 'longitude' => 120.5928],
            ['name' => 'UPPER MAGSAYSAY', 'latitude' => 16.4167, 'longitude' => 120.5956],
            ['name' => 'MALCOLM SQUARE', 'latitude' => 16.4139, 'longitude' => 120.5960],
            ['name' => 'MANUEL ROXAS', 'latitude' => 16.4150, 'longitude' => 120.6079],
            ['name' => 'UPPER MARKET SUBDIVISION', 'latitude' => 16.4167, 'longitude' => 120.5942],
            ['name' => 'MIDDLE QUEZON HILL', 'latitude' => 16.4163, 'longitude' => 120.5747],
            ['name' => 'MILITARY CUT-OFF', 'latitude' => 16.4037, 'longitude' => 120.6005],
            ['name' => 'MINES VIEW PARK', 'latitude' => 16.4240, 'longitude' => 120.6262],
            ['name' => 'EAST MODERN SITE', 'latitude' => 16.4219, 'longitude' => 120.6063],
            ['name' => 'WEST MODERNSITE', 'latitude' => 16.4228, 'longitude' => 120.6031],
            ...
            ['name' => 'UPPER QUEZON HILL', 'latitude' => 16.4167, 'longitude' => 120.5760],
            ['name' => 'EAST QUIRINO HILL', 'latitude' => 16.4310, 'longitude' => 120.5934],
            ['name' => 'LOWER QUIRINO HILL', 'latitude' => 16.4310, 'longitude' => 120.5934],
            ['name' => 'MIDDLE QUIRINO HILL', 'latitude' => 16.4273, 'longitude' => 120.5896],
            ['name' => 'WEST QUIRINO HILL', 'latitude' => 16.4308, 'longitude' => 120.5892],
            ['name' => 'QUIRINO-MAGSAYSAY (UPPER QM)', 'latitude' => 16.4050, 'longitude' => 120.5899],

            // // R Barangays === 4 Barangay
            ['name' => 'RIZAL MONUMENT', 'latitude' => 16.4128, 'longitude' => 120.5918],
            ['name' => 'LOWER ROCK QUARRY', 'latitude' => 16.4091, 'longitude' => 120.5878],
            ['name' => 'MIDDLE ROCK QUARRY', 'latitude' => 16.4085, 'longitude' => 120.5859],
            ['name' => 'UPPER ROCK QUARRY', 'latitude' => 16.4074, 'longitude' => 120.5877],
            ...
            ['name' => 'NORTH SANITARY CAMP', 'latitude' => 16.4304, 'longitude' => 120.5994],
            ['name' => 'SOUTH SANITARY CAMP', 'latitude' => 16.4272, 'longitude' => 120.5967],
            ...
            ['name' => 'SESSION ROAD', 'latitude' => 16.4095, 'longitude' => 120.5992],
            ['name' => 'SLAUGHTER HOUSE AREA', 'latitude' => 16.4202, 'longitude' => 120.5942],
            ['name' => 'SLU-SVP', 'latitude' => 16.3898, 'longitude' => 120.5900],
